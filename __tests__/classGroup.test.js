import ClassGroup from '../esm';

describe('ClassGroup patterns assertions', () => {
    test('string', () => {
    ...
    test('mixture of types with nesting', () => {
        ...
        expect(classGroup).toStrictEqual({
            container:
                'sm-layout sm-layout-front sm-layout-back sm-presentation-front sm-presentation-back sm-interaction',
        });
    });
    ...
    test('overrides results', () => {
        ...
        expect(classGroup).toStrictEqual({
            container:
                'sm-layout sm-layout-front sm-layout-back sm-presentation-override additional-class-from-new-key',
    ...
    test('multiple overrides', () => {
        ...
        expect(classGroup).toStrictEqual({
            container:
                'sm-layout sm-layout-front sm-layout-back sm-presentation-override3 sm-interaction additional-class-from-new-key2',
            string: 'string-styles',
            array: 'array styles',
        });
    });
